  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the best of both worlds with gmail2 - a seamless integration of Gmail and Roundcube, redefining your email management experience."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956600684-97d3a4320e45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxlbWFpbHxlbnwwfHx8fDE2OTA3OTk2MjV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the best of both worlds with gmail2 - a seamless integration of Gmail and Roundcube, redefining your email management experience.`}
            </Text>
            <Box
